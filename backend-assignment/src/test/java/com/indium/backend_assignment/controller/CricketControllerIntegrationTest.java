...
public class CricketControllerIntegrationTest {
    ...
    public void testGetMatchesPlayedByPlayer() {
        ...
        assertEquals("V Kohli has played in 3 match(es).", response);
    }
    ...
    public void testGetScoreDetailsByDate() {
        ...
        String expectedResponse = "Scores for matches on 2008-04-18:\nMatch at M Chinnaswamy Stadium between teams: Royal Challengers Bangalore Kolkata Knight Riders \nTeam: Kolkata Knight Riders scored 205 runs\nTeam: Royal Challengers Bangalore scored 63 runs\n";
